...
import { subdiviseFaces } from "./utils";
    ...
    constructor() {
        ...
        this.setAttribute(
            ...
            new THREE.Float32BufferAttribute(
                [
                    ...[...V1_FLOOR, ...V2_FLOOR, ...V3_FLOOR], // Face 0 (Bottom - Top)
                    ...[...V6_FLOOR, ...V1_FLOOR, ...V3_FLOOR], // Face 1 (Bottom - Middle #1)
                    ...[...V6_FLOOR, ...V3_FLOOR, ...V4_FLOOR], // Face 2 (Bottom - Middle #2)
                    ...[...V6_FLOOR, ...V4_FLOOR, ...V5_FLOOR], // Face 3 (Bottom - Bottom)
                    ...
                    ...[...V5_FLOOR, ...V5_ROOF_, ...V6_FLOOR], // Face 12 (Wall #5 - Top)
                    ...
                    ...subdiviseFaces(
                        [
                            [...V1_ROOF_, ...V2_ROOF_, ...V0_ROOF_], // Face 16 (Top #- Top)
                            [...V2_ROOF_, ...V3_ROOF_, ...V0_ROOF_], // Face 17 (Top - Top)
                            [...V3_ROOF_, ...V4_ROOF_, ...V0_ROOF_], // Face 18 (Top - Top)
                            [...V4_ROOF_, ...V5_ROOF_, ...V0_ROOF_], // Face 19 (Top - Top)
                            [...V5_ROOF_, ...V6_ROOF_, ...V0_ROOF_], // Face 20 (Top - Top)
                            [...V6_ROOF_, ...V1_ROOF_, ...V0_ROOF_], // Face 21 (Top - Top)
                            // [...V1_ROOF_, ...V3_ROOF_, ...V2_ROOF_], // Face 16 (Top - Top)
                            // [...V6_ROOF_, ...V3_ROOF_, ...V1_ROOF_], // Face 17 (Top - Middle #1)
                            // [...V6_ROOF_, ...V4_ROOF_, ...V3_ROOF_], // Face 18 (Top - Middle #2)
                            // [...V6_ROOF_, ...V5_ROOF_, ...V4_ROOF_], // Face 19 (Top - Bottom)
                        ],
                        1
                    ).flat(Infinity),
                ],
...
class TileMaterial extends THREE.MeshStandardMaterial {
     ...
     */
    constructor() {
        super({ color: 0xffffff, roughness: 0.4 });
    }
}
